...
// [Library( "ent_nukecar", Title = "Nuke Car", Spawnable = true )]
// public partial class NukeCarEntity : Prop, IUse
// {
...
// 	private NukeCarWheel frontLeft;
// 	private NukeCarWheel frontRight;
// 	private NukeCarWheel backLeft;
// 	private NukeCarWheel backRight;
...
// 	public NukeCarEntity()
// 	{
// 		frontLeft = new NukeCarWheel( this );
// 		frontRight = new NukeCarWheel( this );
// 		backLeft = new NukeCarWheel( this );
// 		backRight = new NukeCarWheel( this );
// 	}
...
// 	private void LaunchNukeForward()
// 	{
// 		if (Host.IsClient)
// 			return;
...
// 		nuke.SetModel("models/bombs/tsarbomba.vmdl");
// 		nuke.Velocity = Owner.EyeRot.Forward * 2000;
// 	}
...
// 		{
// 			player.Vehicle = this;
// 			player.VehicleController = new NukeCarController();
// 			player.VehicleAnimator = new NukeCarAnimator();
// 			player.VehicleCamera = new NukeCarCamera();
// 			player.Parent = this;
